return {
    Execute = function()
        ...
        local function stopWedge()
            ...
            ----------------------------------------------------------------
            -- HANYA CLEAR ACTIVE MODE JIKA MEMANG WEDGETV
            ----------------------------------------------------------------
        ...
        -- Jadi reconnect setelah respawn tidak menghentikan Sync.
        ----------------------------------------------------------------

        local function connectWedgeLoop(myIndex)
            ...
            wedgeConnection =
                RunService.Heartbeat:Connect(
                    function()
                        ...
                        -- tetapi Wedge tetap harus berjalan.
                        ----------------------------------------------------------------
        ...
        local function startWedge(player)
            ...
            if not myIndex then
                ...
                print(
                    "[WEDGETV] Bot tidak termasuk formasi:",
                    LocalPlayer.Name,
                    LocalPlayer.UserId
                )
        ...
        LocalPlayer.CharacterAdded:Connect(
            function()
                ...
                -- RECONNECT WEDGE
                ----------------------------------------------------------------
                -- Jangan panggil startWedge().
                --
                -- startWedge() memanggil stopOtherModes(),
