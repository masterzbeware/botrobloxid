return {
  Execute = function(tab)
      ...
      if not CombatTab then
          warn("[Medical] Tab Combat tidak ditemukan!")
          return
      end
      ...
      if not getgenv().MedicalHooked then
          getgenv().MedicalHooked = true
      ...
      print("✅ [Auto Heal] Sistem real-time aktif. Urutan: Dressing → Bandage → Dressing")
  end
}