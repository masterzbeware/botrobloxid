return {
    Execute = function()
        ...
        local turnLeftActive = false
        local turnLeftConnection = nil
        ...
        -- Bot terakhir akan berada 90 derajat ke kiri
        local turnDistance = 3

        -- Berapa lama Bot 11 berjalan menuju posisi belok
        ...
        local function stopTurnLeft()

            turnLeftActive = false
            targetPlayer = nil

            if turnLeftConnection then

                turnLeftConnection:Disconnect()
                turnLeftConnection = nil
        ...
        ----------------------------------------------------------------
        --
        -- Bot 1 - Bot 10 berada dalam barisan.
        --
        -- Posisi:
        --
        ...
        local function getFormationPosition(
            ...
            ------------------------------------------------------------
            -- BARISAN BERGERAK DARI KANAN KE KIRI
            ------------------------------------------------------------
        ...
        --                               └────
        --
        -- Bot 11 bergerak 90 derajat ke kiri.
        --
        ----------------------------------------------------------------

        local function getTurnLeftPosition(
            myIndex,
            targetHRP,
            distance
        )
            ...
            ------------------------------------------------------------
            -- POSISI SETELAH BELOK 90 DERAJAT
            ------------------------------------------------------------
        ...
        local function startTurnLeft(player)
        ...
        local function handleCommand(
            ...
            if lower == "!turnleft" then

                startTurnLeft(sender)
