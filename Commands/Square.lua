...
-- Kompatibel penuh dengan Stop.lua
...
return {
  Execute = function(msg, client)
      ...
      -- 🔹 Simpan koneksi baru ke vars.SquareConnection agar bisa dihentikan oleh Stop.lua
      if RunService.Heartbeat then
          vars.SquareConnection = RunService.Heartbeat:Connect(function()
              ...
              -- 🔹 Konfigurasi jarak
              local jarakDepan = tonumber(vars.JarakIkut) or 4
