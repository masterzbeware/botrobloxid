return {
    Execute = function()
        ...
        if not LocalPlayer then
            warn("[StormDance] LocalPlayer tidak ditemukan.")
            return
        end
        ...
        do
            ...
            if success and result then
                ...
                warn("[StormDance] Gagal load Admin.lua.")
                return
        ...
        local STORM_DANCE_ANIMATION_ID =
            "79983231993963"
        ...
        -- dari !stop / !stormdance tidak mengganggu command terbaru.
        ...
        local function restoreNormalAnimation(generation)
            ...
            print(
                "[StormDance] Animasi normal dipulihkan."
            )
        ...
        _G.BotVars.ModeControllers.stormdance =
            stopStormDance
        ...
        local function playStormDance()
            ...
            if not humanoid then
                ...
                warn(
                    "[StormDance] Humanoid tidak ditemukan."
                )
            ...
            if success and result then
                ...
                print(
                    "[StormDance] FE Animation berhasil dimainkan:",
                    STORM_DANCE_ANIMATION_ID,
                    "| Bot:",
                    LocalPlayer.Name
                )
                ...
                warn(
                    "[StormDance] FE Animation gagal dimainkan setelah",
                    maxAttempts,
                    "percobaan.",
                    "| Bot:",
                    LocalPlayer.Name,
        ...
        local function handleCommand(
            ...
            if lower == "!stormdance" then

                print(
                    "[StormDance] Command diterima | Bot:",
                    LocalPlayer.Name,
                    "| Admin:",
                    sender.Name
                )
            ...
            if lower == "!unstormdance" then

                print(
                    "[StormDance] UnStormDance | Bot:",
                    LocalPlayer.Name,
                    "| Admin:",
                    sender.Name
                )
